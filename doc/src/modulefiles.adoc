[id="sec-modulefiles",reftext="`modulefiles`"]
= `modulefiles`
...
application's and the modulefile writer's needs.
...
Defines a string which is displayed in case of the invocation of the `module help` command. The 
string should be the email address of the module maintainer.
